...
android {
  ...
  defaultConfig {
    applicationId = "com.aistudio.simpel.vbgtya"
    minSdk = 24
    targetSdk = 36
    versionCode = 1
    versionName = "1.0"
...
android {
    ...
    buildTypes {
        release {
            ...
            // Catatan: Jika build release Anda nanti error karena masalah Keystore, 
            // Anda bisa berikan tanda // di awal baris di bawah ini untuk sementara.
